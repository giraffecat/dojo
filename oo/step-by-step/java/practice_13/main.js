...
class Teacher extends person {
    ...
    stdudentleader(student){
        return `I am ${this.name}. I know ${student.name} become Leader of Class ${student.klass.number}`
    }
}
var klass1=new Klass(0);
var klass2=new Klass(2);
var classes=[klass1,klass2];
var stduent=new Student('Jerry',21,klass1)
var teacher=new Teacher('Tom',21,classes)
console.log(teacher.stdudentleader(stduent));